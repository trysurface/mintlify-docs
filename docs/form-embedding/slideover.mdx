...
Users can open the slideover form by directly navigating to your website and appending the `showSurfaceForm=true` query parameter to the URL.
...
This will automatically trigger the slideover form to appear when the page loads, without requiring the user to click a trigger button.
