...
description: "Complete reference for all 21 MCP tools available in the Surface Forms MCP server"
sidebarTitle: "Tool Reference"
og:title: "MCP Tool Reference | Surface Docs"
twitter:title: "MCP Tool Reference | Surface Docs"
og:description: "Complete reference for all 21 MCP tools available in the Surface Forms MCP server"
twitter:description: "Complete reference for all 21 MCP tools available in the Surface Forms MCP server"
