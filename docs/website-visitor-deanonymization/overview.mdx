...
You can **view embedding instructions** and **test your embedding** by clicking `Integrate Surface Tag` in the Settings page.

<Frame>
![Surface Tag Integration](/images/settings/integrate-surface-tag.png)
</Frame>
