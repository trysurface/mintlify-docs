...
<Card>
  <ol>
    <li>1. Lead Creation/Update</li>
    <li>2. Attribute Matching</li>
    <li>3. ICP Comparison</li>
    <li>4. Score Calculation</li>
    <li>5. Grade Assignment</li>
  </ol>
</Card>
...
<CardGroup cols={2}>
  <Card title="Company Attributes" icon="building">
    <ol>
      <li>1. Number of Employees</li>
      <li>2. Company Revenue</li>
      <li>3. Industry</li>
      <li>4. Target Geography</li>
    </ol>
  </Card>
