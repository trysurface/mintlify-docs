...
<Frame caption="Conditional Routing">
<img src="/images/conditional-routing.png" alt="Conditional Routing" />
</Frame>
...
<Card title="Routing Tips">
  - Keep flows logical and easy to follow
  - Set default paths for all conditional steps
  - Test all possible paths thoroughly
  - Use clear step names for easier management
