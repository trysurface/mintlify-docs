...
<CardGroup cols={1}>
  <Card title="Basic Elements" icon="shapes">
    ...
    <img src="/images/form-icons/5.svg" alt="Components Library" />
  ...
  <CardGroup cols={4} className="flex flex-wrap gap-3 mt-3">
    ...
    <img src="/images/form-icons/advance/6.svg" alt="Components Library" />
    <img src="/images/form-icons/advance/7.svg" alt="Components Library" />
