...
```bash
npx create-next-app@latest nextjs-surface-form
```
...
2. Using Script (Recommended)
   ...
   useEffect(() => {
       ...
       const SurfaceConstructor = new window.SurfaceEmbed(
           formUrl,
           type,
           type === "popup" ? "surface-form-button" : "surface-form-target"
       );
       if (popupSize) {
   ...
   <Tabs>
    ...
    ```TSX
    import ShowSurfaceForm  from "../surfaceForm-script";

    export default function Home() {
        return (
            <div>
                <ShowSurfaceForm
                    formUrl="https://app.withsurface.com/s/cm1b711u80001l803477zv0n4"
                    type="" {/* popup or inline */}
                    popupSize="" {/* small, medium or large */}
                />
